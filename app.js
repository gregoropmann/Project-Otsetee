                    ...
                    if (userRole === 'merchant') {
                        getDoc(doc(db, "active_merchants", user.uid)).then((docSnap) => {
                            if (docSnap.exists()) {
                                ...
                                // Taastame sisestatud metaväljad kohalikku mällu
        ...
        function renderCatalog() {
            // Täidame väljad salvestatud andmetega
        ...
        window.handleLogout = async function() {
            const isPerm = localStorage.getItem('otset_is_permanent') === 'true';
            // Puhastame seadme kohaliku mälu igal juhul
            ...
            try {
                // Kui oli TAVALINE välkmüük, siis kustutame kohe kaardilt.
                // Kui oli PÜSIKOHT, siis jätame andmebaasi alles!
        ...
        // KRIITILINE TURVAPARANDUS: onSnapshot funktsioonis lukustame teiste markerid
        function initMap() {
            const savedLat = localStorage.getItem('otset_custom_lat');
            const savedLng = localStorage.getItem('otset_custom_lng');
            ...
            // Reaalajas andmete kuulamine ja õigete markerite joonistamine kaardile
            onSnapshot(collection(db, "active_merchants"), (snapshot) => {
                snapshot.docChanges().forEach((change) => {
                    const id = change.doc.id;
                    const data = change.doc.data();
                    
                    // Kui see on praeguse sisselogitud müüja enda punkt, siis tema enda ekraanil 
                    // tegeleb selle kuvamisega updateLocationProcess funktsioon. Me ei joonista seda siin topelt.
                    ...
                    if (change.type === "removed") {
                        ...
                        if (merchantMarkers[id]) {
                            ...
                            // Turvaparandus: Teiste müüjate markerid on alati draggable: false režiimis
        ...
        function updateLocationProcess(lat, lng, accuracy, isRestoring) {
            ...
            // Võtame kohalikust mälust püsikoha seaded
            ...
            // Valime müüjale endale kaardil näitamiseks õige ikooni värvi
            ...
            // KRIITILINE TURVAPARANDUS LOODUD: Uuendame lohistades updateDoc abil asukohta
